...
/**
 * This implementation is identical to that of BooleanArrayListSieve, but skips
 * all of the even sieves.
 * 
 * 10		14037 ns
 * 1000		4.5051E-4 s
 * 10000	.0011299 s
...
public class BooleanArrayListSieveWithEvenSkip extends Sieve {
	...
	public static void main(String[] args) {
		BooleanArrayListSieveWithEvenSkip sieve = new BooleanArrayListSieveWithEvenSkip();
